...
with psycopg2.connect(host="127.0.0.1", user="postgres", password="postgres", database="Home_Work5", port="5432") as conn:
    with conn.cursor() as cur:
        create_tables(cur)
        check_function(cur)
        add_new_client(cur, "Oleg", "Arkhishin", "ol@g.com")
        add_new_client(cur, "Ekaterina", "Buldimova", "ekb@g.com")
        add_new_client(cur, "Ilona", "Dzhanzhariya", "idz@g.com")
